...
<!--    <div class="flex flex-col max-w-sm rounded overflow-hidden bg-white shadow-lg">-->
<!--      <div>-->
<!--         <div class="px-6 py-4">-->
...
<!--  <div v-for="additional in basket_additionals" :key="additional.id" v-if="basket_additionals.length > 0" class="flex flex-col">-->
<!--    <div class="px-6 py-4">-->
