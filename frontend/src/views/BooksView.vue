                          ...
                          <div class="border-r border-b border-l border-gray-400 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r m-2 p-8 flex flex-col justify-between leading-normal">
                              ...
                              <div class="flex items-center">
                                ...
                                <div class="px-6 py-4">
                                        ...
                                        <button v-else @click="addBookToFavourite(book.id)" class="py-4 px-6 text-white rounded-lg border border-blue-400" title="Добавить в избранные">
                              ...
                              <div class="flex items-center">
                                ...
                                <div class="px-6 py-4">
                                        ...
                                        <button v-else @click="addBookToFavourite(book.id)" class="py-4 px-6 mr-2 text-white rounded-lg border border-blue-400" title="Добавить в избранные">
                                          ...
                                          <button @click="addBookToBasket(book.id)" class="py-4 px-6 text-white rounded-lg border border-blue-400" title="Добавить в корзину">
                                               <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#60a5fa" viewBox="0 0 24 24" stroke-width="1.5" class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                              </svg>
                                        </button>
                                          <button @click="deleteBookFromBasket(book.id)" class="py-4 px-6 text-white rounded-lg border border-blue-400" title="Удалить из корзины">
                                               <svg xmlns="http://www.w3.org/2000/svg" fill="#60a5fa" stroke="isCurrent" viewBox="0 0 24 24" stroke-width="1.5" class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                                              </svg>
                                        </button>
       ...
       axios
                ...
                console.log("ASDAS", this.userStore.user.id)
                      axios
                          ...
                          .then(response => {
                              ...
                              this.basket = response.data.baskets
          ...
          axios.post('/api/favourite/add_to_basket/',{ "book_id": bookId, "user_id": localStorage.getItem('user.id') })
              ...
              deleteBookFromBasket(bookId) {
                   ...
                   axios
                       .post(`/api/favourite/delete_basket/`, {"user": this.userStore.user.id, "book": bookId})
                       .then(response => {
                           console.log("message", response.data.message);
                           this.getBasket();
                       })
