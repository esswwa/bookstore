                          ...
                          <div class="bg-white rounded-lg m-2 p-8 flex flex-col justify-between leading-normal">
                            <p class="text-sm text-gray-600 flex items-center">
                                  <svg class="fill-current text-gray-500 w-3 h-3 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                   ...
                                   {{ helperOrder.book.author.text }}, {{helperOrder.book.additional_genre.text_genre.text}}
                                </p>
                                <img class="p-2" src="https://api.lorem.space/image/book?w=200&h=200" alt="Book cover">
                                <div class="text-gray-900 font-medium text-xl mb-2">{{helperOrder.book.name}}</div>
                              ...
                              <div class="flex flex-col">
                                    <span class="inline-block m-2 px-3 py-1 text-sm font-semibold text-gray-700">Количество: {{ helperOrder.count }}</span>
                                    <span class="inline-block m-2 px-3 py-1 text-sm font-semibold text-gray-700">Цена за все: {{ helperOrder.all_price }}</span>
                    </div>
